...
get_binarized_mnist_dataset = SourceFileLoader('get_binarized_mnist_dataset',
                                               'Utilities/get_binarized_mnist_dataset.py').load_module()
...
initialize_weights_in_pytorch = SourceFileLoader('initialize_weights_in_pytorch',
                                                 'Utilities/initialize_weights_in_pytorch.py').load_module()
