...
def omniglot(K=10, structured_or_random='structured', language='English'):
    ...
    fig = plot_mnist_or_omniglot_data(X_merged, y_merged, categories=list(range(1, 11)), n=10, show_plot=False)
    fig.savefig(output_images_dir + '/Binarized Merged Data Characters 1-10.png', bbox_inches='tight')
    plt.close()
    fig = plot_mnist_or_omniglot_data(X_merged, y_merged, categories=list(range(11, 21)), n=10, show_plot=False)
    fig.savefig(output_images_dir + '/Binarized Merged Data Characters 11-20.png', bbox_inches='tight')
    plt.close()
    if language.lower() == 'greek':
        fig = plot_mnist_or_omniglot_data(X_merged, y_merged, categories=list(range(21, 25)), n=10, show_plot=False)
        fig.savefig(output_images_dir + '/Binarized Merged Data Characters 21-24.png', bbox_inches='tight')
    else:
        fig = plot_mnist_or_omniglot_data(X_merged, y_merged, categories=list(range(21, 27)), n=10, show_plot=False)
    ...
    fig.savefig(
        output_images_dir + '/Merged Data with Mixed Missing Values K=' + str(K) + ' Characters 1-10.png',
        bbox_inches='tight'
    )
    plt.close()
    fig = plot_mnist_or_omniglot_data(
    ...
    fig.savefig(
        output_images_dir + '/Merged Data with Mixed Missing Values K=' + str(K) + ' Characters 11-20.png',
        bbox_inches='tight'
    )
    plt.close()
    if language.lower() == 'greek':
        ...
        fig.savefig(
            output_images_dir + '/Merged Data with Mixed Missing Values K=' + str(K) + ' Characters 21-24.png',
            bbox_inches='tight'
        )
    else:
        fig = plot_mnist_or_omniglot_data(
        ...
        fig.savefig(
            output_images_dir + '/Merged Data with Mixed Missing Values K=' + str(K) + ' Characters 21-26.png',
            bbox_inches='tight'
        )
    plt.close()
    ...
    fig.savefig(
        output_images_dir + '/Predicted Merged Data K=' + str(K) + ' Characters 1-10.png',
        bbox_inches='tight'
    )
    plt.close()
    fig = plot_mnist_or_omniglot_data(
    ...
    if language.lower() == 'greek':
        ...
        fig.savefig(
            output_images_dir + '/Predicted Merged Data K=' + str(K) + ' Characters 21-24.png',
            bbox_inches='tight'
        )
    else:
        fig = plot_mnist_or_omniglot_data(
        ...
        fig.savefig(
            output_images_dir + '/Predicted Merged Data K=' + str(K) + ' Characters 21-26.png',
            bbox_inches='tight'
        )
    plt.close()
