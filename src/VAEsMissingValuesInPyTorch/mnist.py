...
def mnist(
    ...
    if digits_or_fashion == 'digits':
        output_images_path = output_img_base_path + 'VAEsMissingValuesInPyTorch/mnist'
        dataset_path = mnist_dataset_path
    else:
        output_images_path = output_img_base_path + 'VAEsMissingValuesInPyTorch/fashion_mnist'
