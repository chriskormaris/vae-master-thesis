...
def cifar10(
    ...
    if rgb_or_grayscale.lower() == 'grayscale':
        output_images_path = output_img_base_path + 'VAEsMissingValuesInPyTorch/cifar10_grayscale'
    else:
        output_images_path = output_img_base_path + 'VAEsMissingValuesInPyTorch/cifar10_rgb'
