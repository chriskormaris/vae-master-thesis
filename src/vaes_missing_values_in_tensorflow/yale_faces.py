...
def yale_faces(latent_dim=64, epochs=100, batch_size='250', learning_rate=0.01, structured_or_random='structured'):
    ...
    output_images_path = os.path.join(output_img_base_path, 'vaes_missing_values_in_tensorflow', 'yale_faces')
    logdir = os.path.join(tensorflow_logs_path, 'yale_faces_vae_missing_values')
    save_path = os.path.join(save_base_path, 'yale_faces_vae_missing_values')
