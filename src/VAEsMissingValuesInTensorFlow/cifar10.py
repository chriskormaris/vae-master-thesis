...
def cifar10(
    ...
    if rgb_or_grayscale.lower() == 'grayscale':
        output_images_path = output_img_base_path + 'VAEsMissingValuesInTensorFlow/cifar10_grayscale'
        ...
        output_images_path = output_img_base_path + 'VAEsMissingValuesInTensorFlow/cifar10_rgb'
