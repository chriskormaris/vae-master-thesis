...
if __name__ == '__main__':
    ...
    output_images_dir = './output_images/VAEsMissingValuesInTensorFlow/binarized_mnist'

    binarized_mnist_dataset_dir = '../Binarized_MNIST_dataset'
    log_dir = './tensorflow_logs/binarized_mnist_vae_missing_values'
    save_dir = './save/binarized_mnist_vae_missing_values'
    ...
    x, loss_summ, apply_updates, summary_op, saver, elbo, x_recon_samples = \
        vae_in_pytorch.vae(batch_size, input_dim, hidden_encoder_dim, hidden_decoder_dim, latent_dim, lr=learning_rate)
